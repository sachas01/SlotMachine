...
(function($){
    ...
    $.jSlots = function(el, options){
        ...
        base.setup = function() {
            ...
            base.$wrapper = $list.wrap('<div class="wrapper"></div>').parent();
        ...
        base.Slot.prototype = {
            ...
            finish : function() {
                ...
                var endNum = base.numbers[that.$el.attr('id')];
        ...
        base.playSlots = function() {
            ...
            base.uuid = (new Date()).getTime();
            base.getNumbers(base.uuid);
